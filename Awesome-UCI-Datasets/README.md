...
The UCI Machine Learning Repository is a collection of databases, domain theories, and data generators that are used by the machine learning community for the empirical analysis of machine learning algorithms.[UCI Machine Learning](https://archive.ics.uci.edu/ml/index.php), this repo contains more than 488 repositories from UCI website.
...
---
## License
[MIT](https://choosealicense.com/licenses/mit/)[Copyright (c) 2022 Kshitij Zutshi]
